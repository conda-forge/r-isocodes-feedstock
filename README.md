...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-isocodes-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-isocodes-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-isocodes-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-isocodes-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-isocodes-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-isocodes-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-isocodes` can be installed with:

```
conda install r-isocodes
```

It is possible to list all of the versions of `r-isocodes` available on your platform with:
